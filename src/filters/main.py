...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Some basic image transofrmations")
    ...
    image = pil_to_array(Image.open(in_image_path), "float")
    ...
    array_to_pil(image).save(out_image_path)
